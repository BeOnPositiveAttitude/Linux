...
Переместим наш блок кода в функцию. Функция в shell-скрипте - это блок кода, который выполняет определенную функционал и может быть переиспользован в теле скрипта. Теперь мы можем вызвать фунцию по имени и передать ей название миссии в качестве аргумента. Также это называется параметром функции.
